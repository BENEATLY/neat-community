...
# MIGRATE: Tables
result = tables.migrateTables()


# RETURN: Status
print(('Successfully migrated tables' if result else 'Failed to migrate tables, see ' + str(createLogFilePath('tables')) + ' for more information.'))
