...
@Component({selector: 'app-template-icon-block', templateUrl: './icon-block.component.html'})


// Component Export Definition
export class TemplateIconBlockComponent implements OnInit {

  // Template Input
  @Input() icon: any = null;
  @Input() background: string = 'linear-gradient(90deg, rgba(51,57,124,1) 0%, rgba(102,36,131,1) 100%)';
  @Input() title: string = '';
  @Input() titleParams: any = {};
  @Input() content: string = '';
  @Input() xxxlColWidth: number = 3;
  @Input() xxlColWidth: number = 3;
  @Input() xlColWidth: number = 4;
  @Input() lgColWidth: number = 6;
  @Input() mdColWidth: number = 6;
