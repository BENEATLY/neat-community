...
@Component({selector: 'app-template-object-table-box', templateUrl: './object-table-box.component.html'})


// Component Export Definition
export class TemplateObjectTableBoxComponent implements OnInit {
