...
@Component({selector: 'app-template-navigation-header', templateUrl: './navigation-header.component.html'})


// Component Export Definition
export class TemplateNavigationHeaderComponent implements OnInit {
  ...
  @Input() defaultObjectView: Boolean = false;
