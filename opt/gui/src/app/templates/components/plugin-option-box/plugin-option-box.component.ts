...
@Component({selector: 'app-template-plugin-option-box', templateUrl: './plugin-option-box.component.html'})


// Component Export Definition
export class TemplatePluginOptionBoxComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.maxWidth = presentLib.determinePropertyNameLineMaxWidthByArray(this.translate, translateLib.constructTranslationPluginOptions(this.appConfig.config, this.context.plugin, this.group, this.translate));
