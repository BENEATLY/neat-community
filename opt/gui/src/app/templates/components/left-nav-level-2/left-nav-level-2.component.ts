...
@Component({selector: 'app-template-left-nav-level-2', templateUrl: './left-nav-level-2.component.html'})


// Component Export Definition
export class TemplateLeftNavLevel2Component implements OnInit {
