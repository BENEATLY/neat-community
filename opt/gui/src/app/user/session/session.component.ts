...
@Component({selector: 'app-user-session', templateUrl: './session.component.html'})
...
export class UserSessionComponent implements OnInit {
  ...
  objectName = 'ActiveSession';
  objectDefinition = 'ActiveSession';
  ...
  accessLevel = {'selected': 'own', 'options': ['own']};
  disabledLevel = ['isolated', 'all'];
  ...
  async update() {
    ...
    // Get Page Info
    dataLib.getPageInfo(this.appConfig.config, this.data.userData, 'model', this.objectDefinition, this.columns, this.pageInfo, this.resultInfo, null, this.sortingArray, this.filterArray, this.filterState, this.displayOptions, null, this.translate, this.timezone, this.snackBar, this.cookieService, this.http);
