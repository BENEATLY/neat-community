...
@Component({selector: 'app-settings-user', templateUrl: './user.component.html'})
...
export class SettingsUserComponent implements OnInit {
  ...
  routeAllowed() {
    ...
    // Sufficient Rights?
    if (!rightLib.sufficientRights(this.data.userData.right, this.objectDefinition, 'Get', 'isolated')) { this.router.navigate([`dashboard`]); }
