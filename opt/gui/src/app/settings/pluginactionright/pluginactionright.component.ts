...
@Component({selector: 'app-settings-pluginactionright', templateUrl: './pluginactionright.component.html'})


// Component Export Definition
export class SettingsPluginActionRightComponent implements OnInit {
  ...
  objectName = 'PluginActionRight';
  objectDefinition = 'PluginActionRight';
