...
@Component({selector: 'app-settings-function', templateUrl: './function.component.html'})


// Component Export Definition
export class SettingsFunctionComponent implements OnInit {
  ...
  routeAllowed() {
    ...
    // Sufficient Rights?
    if (!rightLib.sufficientRights(this.data.userData.right, this.objectDefinition, 'Get', 'all')) { this.router.navigate([`dashboard`]); }
