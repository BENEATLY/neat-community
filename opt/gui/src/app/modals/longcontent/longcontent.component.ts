...
@Component({selector: 'app-longcontent-modal', templateUrl: 'longcontent.component.html'})


// Component Export Definition
export class LongContentModalComponent implements OnInit {
  ...
  constructor(public modalService: ModalService, public translate: TranslateService, public translation: TranslationService) {
    ...
    // Get Value
    if (valLib.isJsonFormat(meta.property)) { this.value = presentLib.beautifyJson(meta.value); }
    else { this.value = meta.value; }
